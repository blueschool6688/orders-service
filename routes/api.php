...
Route::prefix('auth')->name('auth.')->namespace('Auth')->group(function () {
    Route::prefix('client')->name('client.')->group(function () {
        Route::get('login-google',[LoginController::class,'clientLoginGoogle']);
    });
});
...
Route::prefix('auth')->middleware(['installed', 'apiKey', 'localization'])->name('auth.')->namespace('Auth')->group(function () {
    ...
    Route::prefix('client')->name('client.')->group(function () {
        ...
        Route::get('/google-redirect', [LoginController::class, 'clientGoogleRedirect']);
        Route::post('/sso-check', [LoginController::class, 'clientSSOCheck'])->middleware('auth:sanctum-client');
        Route::post('/sso-update-password',[LoginController::class, 'clientSSOUpdatePassword'])->middleware('auth:sanctum-client');
        Route::prefix('signup')->name('signup.')->group(function () {
            Route::post('/', [SignupController::class, 'clientSignup']);
        });
        Route::prefix('forgot-password')->name('forgot-password.')->group(function () {
            Route::post('/', [ForgotPasswordController::class, 'forgotPassword']);
            Route::post('/verify-code', [ForgotPasswordController::class, 'verifyCode']);
        ...
        Route::middleware('auth:sanctum-client')->group(function () {
            Route::middleware('verify.api')->group(function () {
                Route::post('/logout', [LoginController::class, 'clientLogout']);
                Route::post('/delete-account', [DeactivateController::class, 'deleteAccount']);
            });
        });
        ...
        // Client Auth Check
        Route::post('/authcheck', function () {
            if (Auth::guard('sanctum-client')->check()) {
                return response()->json(['status' => true]);
            }
            return response()->json(['status' => false]);
        });
...
Route::prefix('profile')->name('profile.')->middleware(['installed', 'apiKey', 'localization'])->group(function () {
    Route::middleware(['auth:sanctum'])->group(function () {
...
Route::prefix('frontend')->name('frontend.')->middleware(['installed', 'apiKey', 'localization'])->group(function () {
    ...
    Route::prefix('banner')->name('banner.')->group(function () {
        ...
        Route::get('/show/{banner?}', [FrontendBannerController::class, 'show']);
    });
    Route::prefix('branch')->name('branch.')->group(function () {
